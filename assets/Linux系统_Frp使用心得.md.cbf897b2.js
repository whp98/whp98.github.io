...
<span class="line"><span style="color:#e1e4e8;">    bind 127.0.0.1:32000</span></span>
...
<span class="line"><span style="color:#e1e4e8;">    option tcplog</span></span>
<span class="line"><span style="color:#e1e4e8;">    server one45671	127.0.0.1:45671 check inter 1000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#e1e4e8;">    server one45672	127.0.0.1:45672 check inter 1000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#e1e4e8;">    server one45673	127.0.0.1:45673 check inter 5000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#e1e4e8;">    server one45674	127.0.0.1:45674 check inter 5000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#e1e4e8;">    option redispatch</span></span>
<span class="line"><span style="color:#e1e4e8;">        </span></span>
...
<span class="line"><span style="color:#e1e4e8;">    stats refresh 200ms</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#24292e;">#logging options</span></span>
...
<span class="line"><span style="color:#24292e;">    bind 127.0.0.1:32000</span></span>
...
<span class="line"><span style="color:#24292e;">    option tcplog</span></span>
<span class="line"><span style="color:#24292e;">    server one45671	127.0.0.1:45671 check inter 1000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#24292e;">    server one45672	127.0.0.1:45672 check inter 1000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#24292e;">    server one45673	127.0.0.1:45673 check inter 5000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#24292e;">    server one45674	127.0.0.1:45674 check inter 5000 rise 2 fall 2</span></span>
<span class="line"><span style="color:#24292e;">    option redispatch</span></span>
<span class="line"><span style="color:#24292e;">        </span></span>
...
<span class="line"><span style="color:#24292e;">    stats refresh 200ms</span></span></code></pre></div><p>使用可以打开 <code>http://localhost:8990/frp-stats</code> 查看服务状态。</p><p>本地使用 127.0.0.1:32000 连接即可</p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>以上就是我目前的体会和经验 要是frp有升级我再尝试优化</p>`,31),o=[l];function t(c,r,i,y,h,d){return n(),a("div",null,o)}const m=s(p,[["render",t]]);export{f as __pageData,m as default};
