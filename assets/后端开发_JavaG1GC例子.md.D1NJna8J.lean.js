import{_ as a,c as n,a3 as p,o as e}from"./chunks/framework.C4Vvvhxx.js";const X=JSON.parse('{"title":"Java G1GC例子带注释","description":"","frontmatter":{},"headers":[],"relativePath":"后端开发/JavaG1GC例子.md","filePath":"后端开发/JavaG1GC例子.md","lastUpdated":1726751071000}'),l={name:"后端开发/JavaG1GC例子.md"};function i(c,s,t,r,o,d){return e(),n("div",null,s[0]||(s[0]=[p(`<h1 id="java-g1gc例子带注释" tabindex="-1">Java G1GC例子带注释 <a class="header-anchor" href="#java-g1gc例子带注释" aria-label="Permalink to &quot;Java G1GC例子带注释&quot;">​</a></h1><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span># gc设置 beg</span></span>
