...
<span class="line"><span>    stats refresh 200ms</span></span></code></pre></div><p>使用可以打开 <code>http://localhost:8990/frp-stats</code> 查看服务状态。</p><p>本地使用 127.0.0.1:32000 连接即可</p><h2 id="总结" tabindex="-1">总结 <a class="header-anchor" href="#总结" aria-label="Permalink to &quot;总结&quot;">​</a></h2><p>以上就是我目前的体会和经验 要是frp有升级我再尝试优化</p>`,31),t=[l];function i(c,o,r,h,d,u){return n(),s("div",null,t)}const m=a(e,[["render",i]]);export{_ as __pageData,m as default};
