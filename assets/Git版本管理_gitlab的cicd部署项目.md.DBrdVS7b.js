import{_ as s,c as i,o as a,a8 as n}from"./chunks/framework.CjPLpqWJ.js";const y=JSON.parse('{"title":"gitlab的cicd部署项目","description":"","frontmatter":{},"headers":[],"relativePath":"Git版本管理/gitlab的cicd部署项目.md","filePath":"Git版本管理/gitlab的cicd部署项目.md","lastUpdated":1719366542000}'),l={name:"Git版本管理/gitlab的cicd部署项目.md"},p=n(`<h1 id="gitlab的cicd部署项目" tabindex="-1">gitlab的cicd部署项目 <a class="header-anchor" href="#gitlab的cicd部署项目" aria-label="Permalink to &quot;gitlab的cicd部署项目&quot;">​</a></h1><p>本次部署有来的admin项目</p><p>项目结构</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>├── README.md</span></span>
<span class="line"><span>├── vue3-element-admin</span></span>
<span class="line"><span>└── youlai-boot</span></span></code></pre></div><div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">stages</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    - </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">main</span></span></code></pre></div>`,5),t=[p];function h(k,e,E,d,r,g){return a(),i("div",null,t)}const o=s(l,[["render",h]]);export{y as __pageData,o as default};
