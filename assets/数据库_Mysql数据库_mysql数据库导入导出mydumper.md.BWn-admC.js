import{_ as s,c as n,o as a,a8 as e}from"./chunks/framework.CjPLpqWJ.js";const f=JSON.parse('{"title":"mysql数据库导入导出mydumper","description":"","frontmatter":{},"headers":[],"relativePath":"数据库/Mysql数据库/mysql数据库导入导出mydumper.md","filePath":"数据库/Mysql数据库/mysql数据库导入导出mydumper.md","lastUpdated":1723028731000}'),p={name:"数据库/Mysql数据库/mysql数据库导入导出mydumper.md"},i=e(`<h1 id="mysql数据库导入导出mydumper" tabindex="-1">mysql数据库导入导出mydumper <a class="header-anchor" href="#mysql数据库导入导出mydumper" aria-label="Permalink to &quot;mysql数据库导入导出mydumper&quot;">​</a></h1><h2 id="安装工具" tabindex="-1">安装工具 <a class="header-anchor" href="#安装工具" aria-label="Permalink to &quot;安装工具&quot;">​</a></h2><p><a href="https://github.com/mydumper/mydumper" target="_blank" rel="noreferrer">https://github.com/mydumper/mydumper</a></p><h2 id="_1-导出数据库" tabindex="-1">1. 导出数据库 <a class="header-anchor" href="#_1-导出数据库" aria-label="Permalink to &quot;1. 导出数据库&quot;">​</a></h2><p>简单使用</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mydumper</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  -P</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 3306</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -h</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 1.1.1.1</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">  -u</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> xxx</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> &#39;passwd&#39;</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -t</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -B</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> dbName</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -o</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./dump</span></span></code></pre></div><p>参数介绍</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">mydumper</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --help</span></span></code></pre></div><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>用法：</span></span>
...
<span class="line"><span># fifodir                               =</span></span></code></pre></div><h2 id="_2-导入数据库" tabindex="-1">2. 导入数据库 <a class="header-anchor" href="#_2-导入数据库" aria-label="Permalink to &quot;2. 导入数据库&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">myloader</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -u</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> user</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -p</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> passwd</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -P</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 23306</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -h</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 127.0.0.1</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -e</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -d</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> ./dump</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> -t</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> 8</span></span></code></pre></div><p>全部参数</p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">myloader</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;"> --help</span></span></code></pre></div><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span>myloader --help</span></span>
<span class="line"><span>用法：</span></span>
...
<span class="line"><span>defaults-file                           = /etc/mydumper.cnf</span></span>
<span class="line"><span># defaults-extra-file                   = </span></span>
<span class="line"><span># fifodir                               =</span></span></code></pre></div>`,14),l=[i];function t(o,c,r,d,h,u){return a(),n("div",null,l)}const b=s(p,[["render",t]]);export{f as __pageData,b as default};
