import{_ as i,c as a,a3 as n,o as p}from"./chunks/framework.ohJJpums.js";const g=JSON.parse('{"title":"快速部署frp","description":"","frontmatter":{},"headers":[],"relativePath":"Linux系统/快速部署frp.md","filePath":"Linux系统/快速部署frp.md","lastUpdated":1717397989000}'),l={name:"Linux系统/快速部署frp.md"};function t(h,s,k,e,F,r){return p(),a("div",null,s[0]||(s[0]=[n(`<h1 id="快速部署frp" tabindex="-1">快速部署frp <a class="header-anchor" href="#快速部署frp" aria-label="Permalink to &quot;快速部署frp&quot;">​</a></h1><p>部署多个端口有利于高可用 以下脚本用于部署4套FRP</p><div class="language-sh vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">sh</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#!/bin/sh</span></span>
