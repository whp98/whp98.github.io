import{_ as i,c as a,a3 as n,o as l}from"./chunks/framework.ohJJpums.js";const g=JSON.parse('{"title":"gitlab的cicd部署项目","description":"","frontmatter":{},"headers":[],"relativePath":"Git版本管理/gitlab的cicd部署项目.md","filePath":"Git版本管理/gitlab的cicd部署项目.md","lastUpdated":1719366542000}'),p={name:"Git版本管理/gitlab的cicd部署项目.md"};function t(h,s,k,e,E,d){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="gitlab的cicd部署项目" tabindex="-1">gitlab的cicd部署项目 <a class="header-anchor" href="#gitlab的cicd部署项目" aria-label="Permalink to &quot;gitlab的cicd部署项目&quot;">​</a></h1><p>本次部署有来的admin项目</p><p>项目结构</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>├── README.md</span></span>
