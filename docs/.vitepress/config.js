...
const SidebarItemFilter = (SidebarItemArr) => {
    ...
    res.sort((e1, e2) => {
        if (e1.link && !e2.link) {
            ...
            return 0;
        } else if (e1.link && e2.link && e1.link.split("/").length > e2.link.split("/").length) {
            return 1;
        } else if (e1.link && e2.link && e1.link.split("/").length < e2.link.split("/").length) {
            return -1;
        } else if (e1.link && e2.link && e1.link.split("/").length === e2.link.split("/").length && e1.link.endsWith("index.html")) {
            return -1
        } else if (e1.link && e2.link && e1.link.split("/").length === e2.link.split("/").length && e2.link.endsWith("index.html")) {
            return 1
