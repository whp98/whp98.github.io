# PhotoPrism使用docker-compose部署



## PhotoPrism docker-compose.yaml 文件
...
services:
  photoprism:
    ...
    volumes:
      ...
      - "E:/WIN_HOME/Pictures:/photoprism/originals"                 # original media files (photos and videos)
...
### 开始索引
打开
http://localhost:2342/library/index
